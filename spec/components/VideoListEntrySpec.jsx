describe('VideoListEntry', function() {
  ...
  beforeEach(function() {
    cuteCatVideo = renderIntoDocument(
      <Wrapper>
        <VideoListEntry video={window.fakeVideoData[0]} handleClick={ () => '' } />
      </Wrapper>
    );

    superCuteCatVideo = renderIntoDocument(
      <Wrapper>
        <VideoListEntry video={window.fakeVideoData[1]} handleClick={ () => '' } />
      </Wrapper>
    );

    hackReactorVideo = renderIntoDocument(
      <Wrapper>
        <VideoListEntry video={window.fakeVideoData[2]} handleClick={ () => '' } />
      </Wrapper>
    );
  });
